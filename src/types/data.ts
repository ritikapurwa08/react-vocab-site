...
export interface WordData {
  id: number;
  word: string;
  // Make these fields optional for the initial state before AI generation
  websterMeaning?: string;
  hindiMeaning?: string;
  sentence?: string;
  // New field to store the mnemonic generated by the AI
  mnemonic?: string;
  level: string;
...
export const initialVocabulary: WordData[] = [
  { id: 1, word: "Ubiquitous", websterMeaning: "Existing or being everywhere at the same time; constantly encountered.", hindiMeaning: "सर्वव्यापी (Sarvavyaapi)", sentence: "Smartphones have become ubiquitous in modern society.", level: "C1", status: "have to learn", mnemonic: "My new 'U-B-I-Q-U-I-T-O-U-S' phone is everywhere I go." },
